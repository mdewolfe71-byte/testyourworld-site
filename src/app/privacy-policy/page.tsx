    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-6 prose prose-gray prose-sm">
          ...
          <p className="text-[var(--gray-600)] leading-relaxed">When you place an order or create an account, we collect your name, email address, mailing address, and payment information. We also collect information about your home (square footage, HVAC type, number of occupants) to provide accurate test results and context in your report.</p>
          <h2 className="text-xl font-[Outfit] font-bold mt-8 mb-3">How We Use Your Information</h2>
          <p className="text-[var(--gray-600)] leading-relaxed">We use your information to process orders, deliver test results, provide customer support, and improve our services. We do not sell your personal information to third parties.</p>
          <h2 className="text-xl font-[Outfit] font-bold mt-8 mb-3">Data Security</h2>
          <p className="text-[var(--gray-600)] leading-relaxed">We implement industry-standard security measures to protect your information. Test results are encrypted and accessible only through your secure Client Portal.</p>
          <h2 className="text-xl font-[Outfit] font-bold mt-8 mb-3">Contact Us</h2>
          <p className="text-[var(--gray-600)] leading-relaxed">If you have questions about this Privacy Policy, contact us at <a href="mailto:support@testyourworld.com" className="text-[var(--cyan)]">support@testyourworld.com</a>.</p>
