...
export const metadata: Metadata = {
  ...
  description: "See something suspicious? Swab it. Send it. Stop guessing. Identifies exact mold species from any surface. Results in 48 hours. $49 USD or CAD.",
};
