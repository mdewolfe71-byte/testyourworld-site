        ...
        <div className="max-w-3xl mx-auto px-6">
          <div className="bg-white rounded-2xl border border-[var(--gray-200)] overflow-hidden">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 text-center">
              <span className="inline-block bg-emerald-500 text-white text-xs font-bold px-3 py-1 rounded-full font-[Outfit] tracking-wide mb-3">QUICK &amp; EASY</span>
              <div className="text-5xl mb-2">🧫</div>
            </div>
            <div className="p-8">
              <h3 className="text-2xl font-[Outfit] font-bold mb-1">Surface Swab Test</h3>
              <p className="text-[var(--cyan)] font-semibold text-sm mb-2">Swab it. Send it. Stop guessing.</p>
              <p className="text-[var(--gray-500)] text-sm italic mb-5">&quot;Is that mold or a really committed dust bunny?&quot;</p>
              ...
              <a href="https://testyourworld.myshopify.com" target="_blank" rel="noopener noreferrer" className="block bg-[var(--cyan)] text-[var(--navy)] text-center py-3.5 rounded-lg font-[Outfit] font-bold text-lg hover:bg-[#00D4ED] transition-all">
                Get Swab Kit — $69
              </a>
            </div>
          </div>
      ...
      <section className="py-20 lg:py-28 bg-[var(--navy)]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {swabSpots.map((spot) => (
              <div key={spot.title} className="bg-[var(--navy-light)] border border-white/5 rounded-2xl p-7 hover:border-[var(--cyan)]/20 transition-all">
                ...
                <span className="text-[var(--green)] text-sm font-semibold">{spot.accent}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 lg:py-28 bg-[var(--gray-100)]">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-[var(--gray-500)]">Four steps. No PhD required.</p>
          </div>
