    ...
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="inline-block px-6 py-2.5 rounded-full border border-white/10 bg-white/5 mt-2">
              <span className="text-gray-300 text-sm">Two ways to test. <strong className="text-cyan">Same lab. Same answers.</strong> Pick what works for you.</span>
            </div>
          </div>
          <div className="hidden lg:block">
            <Image
              src="/images/Wolehome.png.webp"
              alt="HVAC airflow through a house"
              width={560}
              height={420}
      ...
      <section className="py-20 lg:py-28 bg-[#F7FAFC]">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500">Different starting points. Same powerful results.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="relative h-56">
                <Image src="/images/patchonfilter.jpeg" alt="AirPatch on filter" fill className="object-cover" />
              ...
              <div className="p-7">
                ...
                <p className="text-gray-500 text-sm italic mb-4">&quot;I want answers, not a craft project.&quot;</p>
                ...
                <a href="https://testyourworld.myshopify.com" target="_blank" rel="noopener noreferrer" className="block mt-6 bg-cyan text-navy text-center py-3 rounded-lg font-outfit font-bold hover:bg-cyan-dim transition-all">
                  Get AirPatch — $69
                </a>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="relative h-56">
                <Image src="/images/filtercut.png" alt="FilterCut kit" fill className="object-cover" />
                <span className="absolute top-4 left-4 bg-purple-500 text-white text-xs font-bold px-3 py-1 rounded-full font-outfit tracking-wide">HANDS-ON</span>
              </div>
              <div className="p-7">
                <h3 className="text-2xl font-outfit font-bold mb-1">FilterCut</h3>
                <p className="text-cyan font-semibold text-sm mb-2">For the hands-on homeowner.</p>
                <p className="text-gray-500 text-sm italic mb-4">&quot;That dusty filter is about to become useful.&quot;</p>
                <p className="text-gray-600 text-sm leading-relaxed mb-5">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-6">
          <div className="bg-[#F7FAFC] rounded-2xl p-8 text-center border border-gray-200">
        ...
        <div className="max-w-3xl mx-auto px-6">
          <div className="bg-navy rounded-2xl p-8 border border-white/5">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-cyan font-outfit font-bold text-lg mb-2">Pro Tip: Set Your Fan to ON</h3>
                ...
                <span className="inline-block mt-3 text-xs text-cyan border border-cyan/20 px-3 py-1 rounded-full">ASHRAE 62.2 Recommended</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/vent-attachment-.png" alt="AirPatch attached to a vent" width={400} height={300} className="w-full h-64 object-cover" />
              <div className="p-5 bg-white">
                <h4 className="font-outfit font-semibold mb-1">Attaches to Any Vent</h4>
                <p className="text-gray-500 text-sm">Place your AirPatch directly on a vent for targeted room testing.</p>
              </div>
            </div>
            <div className="rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/IMG_2309.jpeg" alt="How filtration works" width={400} height={300} className="w-full h-64 object-cover" />
              <div className="p-5 bg-white">
                <h4 className="font-outfit font-semibold mb-1">How Filtration Works</h4>
                <p className="text-gray-500 text-sm">Your HVAC filter captures particles from every room in your home.</p>
              </div>
            </div>
            <div className="rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/types of filters.jpeg" alt="Different types of air filters" width={400} height={300} className="w-full h-64 object-cover" />
              <div className="p-5 bg-white">
                <h4 className="font-outfit font-semibold mb-1">Works With Any Filter</h4>
                <p className="text-gray-500 text-sm">FilterCut works with all standard HVAC filter types and sizes.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
              {[
                ...
                <div key={card.title} className="bg-navy-light border border-white/5 rounded-2xl p-7 hover:border-cyan/20 transition-all hover:-translate-y-1 duration-300">
            ...
            <div className="hidden lg:block">
              <Image
                ...
                alt="Wide applications for AirPatch"
                width={500}
                height={500}
      ...
      <section className="py-20 lg:py-28 bg-[#F7FAFC]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500">Basically anyone who breathes indoors.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {personas.map((p) => (
              <div key={p.title} className="bg-white rounded-2xl p-7 border border-gray-200 hover:border-cyan/30 hover:-translate-y-2 transition-all duration-300 hover:shadow-xl">
                <span className="text-3xl mb-3 block">{p.emoji}</span>
                <h3 className="text-lg font-outfit font-semibold mb-2">{p.title}</h3>
                <p className="text-gray-500 text-sm leading-relaxed mb-3">{p.text}</p>
                <span className="text-coral text-sm font-semibold">{p.accent}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-navy py-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-3xl lg:text-4xl font-outfit text-white mb-4">
            Your Filter Knows. <span className="text-cyan">Now You Can Too.</span>
          </h2>
